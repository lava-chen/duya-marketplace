---
name: canvas
description: Detailed guide for controlling the DUYA canvas (canvas philosophy, mode classification, zoning conventions, element kinds, coordinates, layout patterns, capture/verify timing). Auto-loaded when Conductor mode is enabled.
paths: []
---
